    ...
    def move(self):
        ...
        try:
            ...
            while not rospy.is_shutdown():
                ...
                # for i in range(self.controller.N):
                #     self.controller.args['p'] = ca.vertcat(self.controller.args['p'], 10000000000) # proceeder pose
                #     self.controller.args['p'] = ca.vertcat(self.controller.args['p'], 10000000000) # proceeder pose
                ...
                if self.obstacle_extraction.obstacle_ahead and index > 0:
                    ...
                    if self.overtaken is False:
                        ...
                        for i in range(self.controller.N):
                            ...
                            # print(self.controller.args['p'][2])
                            self.controller.args['p'][6*(i+1)] = x_ref
                            self.controller.args['p'][6*(i+1) + 1] = y_ref
                            self.controller.args['p'][6*(i+1) + 2] = 0
                            self.controller.args['p'][6*(i+1) + 3] = 0
                            self.controller.args['p'][6*(i+1) + 4] = 0
                            self.controller.args['p'][6*(i+1) + 5] = 0
